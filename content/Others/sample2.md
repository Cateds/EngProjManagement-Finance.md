...
<p class="question-title"><strong>(1.1)</strong> Which of the following best aligns with the principles of Design for Manufacturing (DFM)? <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Increasing the number of parts in a design to improve flexibility in manufacturing.</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Using complex shapes and intricate structures to enhance product uniqueness.</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Minimizing the number of parts and using straightforward shapes to ease production and reduce costs.</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Prioritizing visual design over how easy it is to make.</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>Adding redundant features to ensure product robustness.</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：C</strong></p>
<p>DFM 强调简化零件、降低装配复杂度、减少制造成本。减少零件数并使用简单形状最符合该原则。</p>
</div>
...
<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>It is primarily used to illustrate the effects of a specific problem without identifying its root causes.</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>It is a visual tool used to focus on the sole cause of a given problem.</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>It indicates relationships between various effects with no need for visual tools.</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>It is a visual tool used to logically organize possible causes for a specific problem or effect by graphically displaying them in increasing detail.</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>It is exclusively used to identify effects, without organizing possible causes.</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：D</strong></p>
<p>Cause-effect diagram，也称鱼骨图或 Ishikawa diagram，用来系统整理某个问题的潜在原因。</p>
</div>
...
<p class="question-title"><strong>(1.3)</strong> Which of the following 7QC tools can best be used to study how a process changes over time? <strong>[2]</strong></p>
...
<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：D</strong></p>
<p>Control chart 用时间序列方式观察过程是否稳定、是否存在异常波动。</p>
</div>
...
<p class="question-title"><strong>(1.4)</strong> Which of the following is not considered a project? <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Creating a prototype for a next-generation smartphone.</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Designing and deploying a new software algorithm for real-time data processing in an electronic control system.</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Developing periodic updates for an existing software system in a manufacturing plant.</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Setting up a waste reduction program in an office environment.</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>Designing and constructing a printed circuit board (PCB) for a new electronic device.</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：C</strong></p>
<p>项目是临时性的、产生独特成果；周期性软件更新更像持续运营或例行维护。</p>
</div>
...
<p class="question-title"><strong>(1.5)</strong> This technique can mainly be used in project management to identify risks, particularly in assessing external factors and internal vulnerabilities that can impact the project. <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Failure Modes and Effects Analysis (FMEA)</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Strengths, Weaknesses, Opportunities, and Threats (SWOT)</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Internal Rate of Return (IRR)</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Net Present Value (NPV)</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>Benefit-Cost Ratio (BCR)</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：B</strong></p>
<p>SWOT 同时考虑内部 strengths/weaknesses 与外部 opportunities/threats，常用于风险识别。</p>
</div>
...
<p class="question-title"><strong>(1.6)</strong> Carmen arranges a meeting with the steering committee and project sponsor to take them through the case study, answer questions, and seek official confirmation that the case study meets their expectations. What process is she performing here? <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Deliverables Acceptance.</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Accept Deliverables.</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Validate Scope.</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Plan Scope Management.</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>Close Project or Phase.</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：C</strong></p>
<p>Validate Scope 是让客户或发起人正式确认交付物符合要求的过程。</p>
</div>
...
<p class="question-title"><strong>(1.7)</strong> The following organizational structures should be labeled as: <strong>[2]</strong></p>

<p><img src="../Assets/sample-exam/sample2-q1-7-org-structures.png" alt="Company growth organizational structure diagrams"></p>
...
<p>结构从直接协作的初创企业，发展为出现领导者的扩张阶段，再到更多员工的增长阶段，最后形成多层级正式组织。</p>
</div>
...
<p class="question-title"><strong>(1.8)</strong> Which of the following statements does NOT adhere to the sustainability principle “Use resources efficiently and effectively”? <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Understand there are environmental limits and finite resources.</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Use systems and products that reduce embedded carbon, energy and water use, waste, and pollution.</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Engage a waste management contractor who specializes in shipping waste to regions with lower environmental standards.</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Adopt strategies for re-use, recycling, decommissioning, and disposal of components and materials.</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>Work to repair any damage.</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：C</strong></p>
<p>把废弃物转移到环境标准更低的地区不是资源高效使用，而是转嫁环境责任。</p>
</div>
...
<p class="question-title"><strong>(1.9)</strong> Consider the structure of a start-up company run by an entrepreneur. Find the correct pair of true statements. <strong>[2]</strong></p>

<p>1. Maximum standardisation and formalisation<br>2. Few layers: Limited middle-line managerial levels<br>3. Decentralized and indirect supervision<br>4. Wide span of control around the entrepreneur</p>
...
<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：D</strong></p>
<p>初创结构通常层级少、形式化低，创业者直接监督且控制幅度较宽。</p>
</div>
...
<p class="question-title"><strong>(1.10)</strong> It costs 1000 RMB for hand tools and 1.50 RMB labor per unit. An automated alternative costs 15,000 RMB with 0.50 RMB per-unit cost. With annual production of 5000 units, how long will it take to reach the production cost cross-over point? <strong>[2]</strong></p>
...
<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：D</strong></p>
<p>固定成本差为 14,000 RMB，单位节省为 1 RMB，因此交叉点为 14,000 件；按 5,000 件/年，需要 2.8 年。</p>
</div>
...
<p class="question-title"><strong>(1.11)</strong> When developing a new product, which stage has the biggest impact on the final product's price, quality, and manufacturing time? <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Mostly during manufacturing</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Mostly during product development</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Equally during product development and manufacturing</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Mostly during sales and marketing</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>After customer feedback during mass production</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：B</strong></p>
<p>产品成本、质量和制造时间的大部分影响在产品开发/设计阶段已经被锁定。</p>
</div>
...
<p class="question-title"><strong>(1.12)</strong> In the execution phase of a project, key man resources are lost, and new staff join. The project manager sets up a meeting with the new team. What should be the most important agenda item? <strong>[2]</strong></p>

<div class="quiz-options">
<button class="quiz-option" data-option="A" type="button"><span class="quiz-option-letter">A</span><span>Discussing team building activities</span></button>
<button class="quiz-option" data-option="B" type="button"><span class="quiz-option-letter">B</span><span>Reviewing WBS and responsibilities of all team members</span></button>
<button class="quiz-option" data-option="C" type="button"><span class="quiz-option-letter">C</span><span>Inviting the team members to share their past project experiences</span></button>
<button class="quiz-option" data-option="D" type="button"><span class="quiz-option-letter">D</span><span>Planning risk responses for existing risks</span></button>
<button class="quiz-option" data-option="E" type="button"><span class="quiz-option-letter">E</span><span>Assigning someone from the new members to lead the meeting</span></button>
</div>

<div class="quiz-explanation">
<p><strong class="quiz-answer">参考答案：B</strong></p>
<p>关键人员变化后，最重要的是重新明确范围、工作包和责任分配。</p>
</div>
